...
import org.openqa.selenium.support.ui.Select;
	...
	public class BaseClass {
		...
		public static void screenshot(String path) throws IOException {
			...
			File destinateFile = new File("C:\\Users\\joyc0\\eclipse-workspace\\Adactin\\Screenshot");
		...
		public static void mouseHoverToElement(WebElement element) throws InterruptedException {
			Thread.sleep(3000);
			try {
				Actions ac = new Actions(driver);
